...
def process_job(job_id: str, video_path: str, forced_lang: Optional[str] = None):
    try:
        _set_status(job_id, "running")
        _set_progress(job_id, 10, "Extrakcia audia a delenie na úseky…")
        ...
        for i, wav_path in enumerate(chunk_files, start=1):
            ...
            if i == 1:
                JOBS[job_id]["source_lang"] = result.get("language", forced_lang or None)
